...
class Room(db.Model):
    ...
    capacity = db.Column(db.Integer, nullable=False)  # number of tenants that can occupy
...
class TenantPreference(db.Model):
    ...
    min_capacity = db.Column(db.Integer, nullable=False)  # minimum number of tenants
